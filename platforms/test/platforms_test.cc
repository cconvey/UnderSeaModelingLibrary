 ...
 * platform_model::update() method and tests to see if the sensor moved to a
 * new location,
 */
BOOST_AUTO_TEST_CASE(attach_platform) {
    cout << "=== platforms_test: attach_platform ===" << endl;
    ...
    platform_model::sptr sensor(new platform_model(0, "sensor"));
